    ...
    const ShopPage = () => {
      ...
      const [visibleProducts, setVisibleProducts] = useState(initialVisibleProducts); // Show 8 items initially
      ...
      const loadMore = () => {
        setVisibleProducts((prevVisible) => prevVisible + initialVisibleProducts); 
      };
      ...
      return (
        <div className='m-h-screen bg-gray-100 py-2'>
          <div className='container p-4 mt-2'>
            ...
            {products.products && products.products.length > initialVisibleProducts && (
